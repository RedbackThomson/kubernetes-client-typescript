...
export interface V1alpha1BasicSchedulingPolicy {
  [key: string]: unknown;
}
...
export interface V1alpha1GangSchedulingPolicy {
  minCount: number;
}
...
export interface V1alpha1PodGroup {
  name: string;
  policy: V1alpha1PodGroupPolicy;
}

export interface V1alpha1PodGroupPolicy {
  basic?: V1alpha1BasicSchedulingPolicy;
...
export interface V1alpha1TypedLocalObjectReference {
  apiGroup?: string;
  kind: string;
  name: string;
}
...
export interface V1alpha1Workload {
  apiVersion?: string;
  kind?: string;
  metadata?: V1ObjectMeta;
...
export interface V1alpha1WorkloadList {
  apiVersion?: string;
  items: V1alpha1Workload[];
  kind?: string;
  metadata?: V1ListMeta;
}

export interface V1alpha1WorkloadSpec {
  controllerRef?: V1alpha1TypedLocalObjectReference;
  podGroups: V1alpha1PodGroup[];
}
...
export interface V1alpha3DeviceTaintRuleStatus {
  conditions?: V1Condition[];
}
...
export interface V1beta1PodCertificateRequest {
  apiVersion?: string;
  kind?: string;
  metadata?: V1ObjectMeta;
...
export interface V1beta1PodCertificateRequestList {
  apiVersion?: string;
  items: V1beta1PodCertificateRequest[];
  kind?: string;
  metadata?: V1ListMeta;
}

export interface V1beta1PodCertificateRequestSpec {
...
export interface V1beta1PodCertificateRequestStatus {
...
export interface V1beta1StorageVersionMigration {
  apiVersion?: string;
  kind?: string;
  metadata?: V1ObjectMeta;
...
export interface V1beta1StorageVersionMigrationList {
  apiVersion?: string;
  items: V1beta1StorageVersionMigration[];
  kind?: string;
  metadata?: V1ListMeta;
}

export interface V1beta1StorageVersionMigrationSpec {
  resource: V1GroupResource;
}

export interface V1beta1StorageVersionMigrationStatus {
  conditions?: V1Condition[];
...
export interface V1GroupResource {
  group: string;
  resource: string;
}
