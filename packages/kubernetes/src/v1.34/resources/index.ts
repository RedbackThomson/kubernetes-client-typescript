...
export interface PodcertificaterequestsClient extends ResourceClient<V1alpha1PodCertificateRequest, V1alpha1PodCertificateRequestList, "namespaced"> {
  status: ResourceClient<V1alpha1PodCertificateRequest, V1alpha1PodCertificateRequest, "namespaced">;
}

export function podcertificaterequests(client: KubernetesClient): PodcertificaterequestsClient {
  const base = createResourceClient<V1alpha1PodCertificateRequest, V1alpha1PodCertificateRequestList, "namespaced">(client, {
    apiVersion: "certificates.k8s.io/v1alpha1",
  ...
  return {
    ...base,
    status: createResourceClient<V1alpha1PodCertificateRequest, V1alpha1PodCertificateRequest, "namespaced">(
      client,
      {
          apiVersion: "certificates.k8s.io/v1alpha1",
          plural: "podcertificaterequests",
