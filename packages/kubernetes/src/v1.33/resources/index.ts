...
export interface AdmissionregistrationV1ValidatingadmissionpoliciesClient extends ResourceClient<V1ValidatingAdmissionPolicy, V1ValidatingAdmissionPolicyList, "cluster"> {
...
export function admissionregistrationV1Validatingadmissionpolicybindings(client: KubernetesClient): ResourceClient<V1ValidatingAdmissionPolicyBinding, V1ValidatingAdmissionPolicyBindingList, "cluster"> {
...
export function mutatingadmissionpolicies(client: KubernetesClient): ResourceClient<V1alpha1MutatingAdmissionPolicy, V1alpha1MutatingAdmissionPolicyList, "cluster"> {
  return createResourceClient(client, {
...
export function mutatingadmissionpolicybindings(client: KubernetesClient): ResourceClient<V1alpha1MutatingAdmissionPolicyBinding, V1alpha1MutatingAdmissionPolicyBindingList, "cluster"> {
  return createResourceClient(client, {
    apiVersion: "admissionregistration.k8s.io/v1alpha1",
...
export interface AdmissionregistrationV1beta1ValidatingadmissionpoliciesClient extends ResourceClient<V1beta1ValidatingAdmissionPolicy, V1beta1ValidatingAdmissionPolicyList, "cluster"> {
  status: ResourceClient<V1beta1ValidatingAdmissionPolicy, V1beta1ValidatingAdmissionPolicy, "cluster">;
}
...
export function admissionregistrationV1beta1Validatingadmissionpolicies(client: KubernetesClient): AdmissionregistrationV1beta1ValidatingadmissionpoliciesClient {
  const base = createResourceClient<V1beta1ValidatingAdmissionPolicy, V1beta1ValidatingAdmissionPolicyList, "cluster">(client, {
  ...
  return {
    ...base,
    status: createResourceClient<V1beta1ValidatingAdmissionPolicy, V1beta1ValidatingAdmissionPolicy, "cluster">(
      client,
      {
          apiVersion: "admissionregistration.k8s.io/v1beta1",
          plural: "validatingadmissionpolicies",
...
export function admissionregistrationV1beta1Validatingadmissionpolicybindings(client: KubernetesClient): ResourceClient<V1beta1ValidatingAdmissionPolicyBinding, V1beta1ValidatingAdmissionPolicyBindingList, "cluster"> {
  return createResourceClient(client, {
    apiVersion: "admissionregistration.k8s.io/v1beta1",
    plural: "validatingadmissionpolicybindings",
    namespaced: false,
...
export function devicetaintrules(client: KubernetesClient): ResourceClient<V1alpha3DeviceTaintRule, V1alpha3DeviceTaintRuleList, "cluster"> {
  return createResourceClient(client, {
...
export function resourceApiV1alpha3Deviceclasses(client: KubernetesClient): ResourceClient<V1alpha3DeviceClass, V1alpha3DeviceClassList, "cluster"> {
  return createResourceClient(client, {
    apiVersion: "resource.k8s.io/v1alpha3",
...
export interface ResourceApiV1alpha3ResourceclaimsClient extends ResourceClient<V1alpha3ResourceClaim, V1alpha3ResourceClaimList, "namespaced"> {
  status: ResourceClient<V1alpha3ResourceClaim, V1alpha3ResourceClaim, "namespaced">;
}

export function resourceApiV1alpha3Resourceclaims(client: KubernetesClient): ResourceApiV1alpha3ResourceclaimsClient {
  const base = createResourceClient<V1alpha3ResourceClaim, V1alpha3ResourceClaimList, "namespaced">(client, {
    apiVersion: "resource.k8s.io/v1alpha3",
  ...
  return {
    ...base,
    status: createResourceClient<V1alpha3ResourceClaim, V1alpha3ResourceClaim, "namespaced">(
      client,
      {
          apiVersion: "resource.k8s.io/v1alpha3",
          plural: "resourceclaims",
...
export function resourceApiV1alpha3Resourceclaimtemplates(client: KubernetesClient): ResourceClient<V1alpha3ResourceClaimTemplate, V1alpha3ResourceClaimTemplateList, "namespaced"> {
  return createResourceClient(client, {
    apiVersion: "resource.k8s.io/v1alpha3",
...
export function resourceApiV1alpha3Resourceslices(client: KubernetesClient): ResourceClient<V1alpha3ResourceSlice, V1alpha3ResourceSliceList, "cluster"> {
  return createResourceClient(client, {
    apiVersion: "resource.k8s.io/v1alpha3",
...
export function storageV1alpha1Volumeattributesclasses(client: KubernetesClient): ResourceClient<V1alpha1VolumeAttributesClass, V1alpha1VolumeAttributesClassList, "cluster"> {
  return createResourceClient(client, {
...
export interface StorageversionmigrationsClient extends ResourceClient<V1alpha1StorageVersionMigration, V1alpha1StorageVersionMigrationList, "cluster"> {
  status: ResourceClient<V1alpha1StorageVersionMigration, V1alpha1StorageVersionMigration, "cluster">;
}

export function storageversionmigrations(client: KubernetesClient): StorageversionmigrationsClient {
  const base = createResourceClient<V1alpha1StorageVersionMigration, V1alpha1StorageVersionMigrationList, "cluster">(client, {
  ...
  return {
    ...base,
    status: createResourceClient<V1alpha1StorageVersionMigration, V1alpha1StorageVersionMigration, "cluster">(
      client,
      {
          apiVersion: "storagemigration.k8s.io/v1alpha1",
          plural: "storageversionmigrations",
